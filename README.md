...
- Built and shipped full-stack features across frontend, backend, and database layers, focusing on clean APIs and maintainable abstractions.
- Strong problem-solving background grounded in data structures and algorithms, with emphasis on writing correct, efficient solutions.
- Comfortable working in collaborative environments: reviewing code, writing clear PRs, and iterating quickly based on feedback.
